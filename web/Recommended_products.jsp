...
<html lang="en">
    ...
    %>
    <script>alert('Product Ordered Successfully');</script>
    <%            }
    %>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navigation">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link btn btn-default" href="Recommended_products.jsp">
                                    ...
                                    <div class="row">
                                        <%
                                            ...
                                            try {
                                                ...
                                                for (String pro : spro) {
                                                    ResultSet rs = st.executeQuery("SELECT * FROM product WHERE pname ='" + pro + "'");
